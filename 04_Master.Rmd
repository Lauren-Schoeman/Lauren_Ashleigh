...
>*Answer 3:* Model 2 ,as the p-value is significant (<0.001) meaning we have enough evidence to reject the null hypothesis and conclude that the full model significantly reduces the residual sum of squares and is therefore better.
...
>*Answer 6:* AIC can't compare models built with different assumptions such as NLS and AIC.
